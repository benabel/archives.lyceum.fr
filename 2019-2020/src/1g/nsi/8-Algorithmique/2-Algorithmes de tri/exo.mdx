...
<!-- TODO passer cette question dans le tri par insertion -->

2. On souhaite insérer dans une liste `tab` déjà trié un nouvel élément `e` de sorte que la nouvelle liste soit également triée.
