...
![Image d'une carte interactive des stations de vélo bleu à Nice](../images/carte-velobleu-Nice.png)

:::

::: appli

[Évaluation diagnostique PP78-79](https://lienmini.fr/3389-402).
...
: Les coordonnées GPS sont déterminées en mesurant avec une grande précision les **distances** entre le
terminal et _trois satellites_.

<wc-wikimage title="3D_Trilateration.jpg" caption="Deux cercles se coupent en deux points, il faut un troisième satellite pour déterminer lequel correspond à la position."/>


::: appli

Un signal de satellite met 1 vingtième de seconde pour se propager du satellite au terminal. En
déduire la distance qui sépare le satellite et le terminal sachant que la vitesse de la lumière est
de 300 mille km/s.
