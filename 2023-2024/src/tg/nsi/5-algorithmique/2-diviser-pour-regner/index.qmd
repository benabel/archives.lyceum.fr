...
Et voici une implémentation en python qui utilise les [listes en compréhension](/1g/nsi/3-representation-des-donnees-types-construits/2-usages-avances-des-tableaux#tableau-donn%C3%A9-en-compr%C3%A9hension):
