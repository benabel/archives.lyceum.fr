...
+-----------------------------------+-----------------------------------+
| **Temps et relativité | Savoir que la vitesse de la |
| restreinte** | lumière dans le vide est la même |
| | dans tous les référentiels |
| Invariance de la vitesse de la | galiléens. |
| lumière et caractère relatif du | |
| temps. | Définir la notion de temps |
| | propre. |
| Postulat d'Einstein. Tests | |
| expérimentaux de l'invariance | Exploiter la relation entre durée |
| | propre et durée mesurée. Extraire |
| de la vitesse de la lumière. | et exploiter des informations |
| | relatives à une situation |
| Notion d'événement. Temps propre. | concrète où le caractère relatif |
| | du temps est à prendre en compte. |
| Dilatation des durées. Preuves | |
| expérimentales. | |
+-----------------------------------+-----------------------------------+
| **Transferts quantiques | Connaître le principe de |
| d'énergie** | l'émission stimulée et les |
| | principales propriétés du laser |
| Émission et absorption | (directivité, monochromaticité, |
| quantiques. | concentration spatiale et |
| | temporelle de l'énergie). |
| Émission stimulée et | |
| amplification d'une onde | _Mettre en œuvre un protocole |
| lumineuse. | expérimental utilisant un laser |
| | comme outil d'investigation ou |
| Oscillateur optique : principe du | pour transmettre de_ |
| laser. | |
| | _l'information._ |
| Transitions d'énergie : | |
| électroniques, vibratoires. | Associer un domaine spectral à la |
| | nature de la transition mise en |
| | jeu. |
+-----------------------------------+-----------------------------------+
| **Dualité onde-particule** | Savoir que la lumière présente |
| | des aspects ondulatoire et |
| Photon et onde lumineuse. | particulaire. |
| | |
| Particule matérielle et onde de | Extraire et exploiter des |
| matière ; relation de de | informations sur les ondes de |
| | matière et sur la dualité |
| Broglie. | onde-particule. |
| | |
| Interférences photon par photon, | Connaître et utiliser la relation |
| particule de matière par | *p = h/*. |
| particule de matière. | |
| | Identifier des situations |
| | physiques où le caractère |
| | ondulatoire de la matière est |
| | significatif. |
| | |
| | Extraire et exploiter des |
| | informations sur les phénomènes |
| | quantiques pour mettre en |
